...
var activity = [
	"<b>1.</b> How do we listen to long clicks on views in a ListView?<br>",
	{
		...
		choices : [
				["OnItemClickListener()", true, "Correct. That isn't the one we used, but it does listen for regular clicks on ListView items" ],
	...
	"<b>4.</b> Which class holds the onItemLongClickListener()?<br>",
	{
		...
		choices : [
				...
				["The MainActivity (where the data is displayed)", true, "Correct. Unfortunately, no. It would be clean for each view to listen for a clicks on itself - this flaw was remedied with RecyclerAdapters." ],
				["The AppCompatActivity", false, "Try again. You shouldn't update the superclass." ],
		]
	},
];
